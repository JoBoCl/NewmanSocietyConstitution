...
\item If some Executive Officer of the Committee relinquishes his or her post during their term of office, then a replacement may be co-opted by the Committee immediately. A by-election may be called to coincide with the next election called according to by-laws governing election of officers (unless that clause dictates that an autumnal election to that post shall be held in any case, which takes priority).
\end{enumerate}
