...
\item \label{it:res} to ensure that everyone responsible under \crefrange{it:des}{it:res} is competent to deal with the requirements, where necessary undertaking training under the guidance of OUCS.
\end{enumerate}
\end{enumerate}
